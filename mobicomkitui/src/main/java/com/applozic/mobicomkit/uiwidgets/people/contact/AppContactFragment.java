...
import com.applozic.mobicomkit.uiwidgets.people.fragment.InitiateDialogFragment;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id==R.id.menu_tambah){
            ...
            FragmentTransaction fragmentTransaction = supportFragmentManager
                    .beginTransaction();
            Fragment prev = getActivity().getSupportFragmentManager().findFragmentByTag("InitiateDialogFragment");
            if (prev != null) {
        ...
        if (!resInfos.isEmpty()) {
            ...
            for (ResolveInfo resInfo : resInfos) {
                ...
                if (packageName.contains("com.twitter.android")
                    ...
                    intent.putExtra(Intent.EXTRA_TEXT, "https://github.com/SeptiawanAjiP/meet/");
                    intent.putExtra(Intent.EXTRA_SUBJECT, "download meetupmessenger");
