    ...
    public void onReceive(final Context context, Intent intent) {
        ...
        if (!TextUtils.isEmpty(messageJson)) {
            ...
            final NotificationService notificationService =
                    new NotificationService(notificationId == 0 ? R.drawable.ic_meetup_white: notificationId, context, R.string.wearable_action_label, R.string.wearable_action_title, R.drawable.mobicom_ic_action_send);
