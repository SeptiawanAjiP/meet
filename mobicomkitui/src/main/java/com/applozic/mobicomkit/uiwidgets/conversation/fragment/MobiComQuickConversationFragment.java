...
public class MobiComQuickConversationFragment extends Fragment implements SearchListFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listView.setBackgroundColor(getResources().getColor(R.color.LightBackground));
...
//        toolbar.setClickable(false);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id==R.id.menu_logout){
            ...
            userLogoutTask = new UserLogoutTask(userLogoutTaskListener,getActivity());
